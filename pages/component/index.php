...
<hr>
<div class="content">
  <h6><a class="text-light" style="text-decoration: none;" href="journal.php">Instructions for authors</a></h6>
  <h6><a class="text-light" style="text-decoration: none;" href="manuscript.php">Submit Manuscript</a></h6>
  <h6><a class="text-light" style="text-decoration: none;" href="aim&scope.php">Aim & Scope</a></h6>
  <h6><a class="text-light" style="text-decoration: none;" href="processcharge.php">Process charge</a></h6>
...
<div class="content-2">
  ...
  <div class="card p-4 m-4 text-center">
    ...
    <div>
      <a href="manuscript.php" class="btn btn-primary text-light">Upload</a>
    </div>
  </div>

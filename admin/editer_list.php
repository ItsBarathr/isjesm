...
<head>
    ...
    <title>Editer List|| isjesm</title>
    <!-- cdn links start -->
    ...
    <div class="table" id="data">
        <table>
            ...
            <tbody>
                ...
                $fatch_editer =  mysqli_query($conn, "SELECT * FROM editer");
                ...
                while($editer_list = mysqli_fetch_assoc($fatch_editer)) {
                    ...
                    echo "<tbody>";
                    echo "<tr>";
                    echo "<td  class='text-light'>" . $editer_list['name'] . "</td>";
                    echo "<td><a class='text-light' href='mailto:" . $editer_list['email'] . "?subject=ISJESM '>Mail</a></td>";
                    echo "<td  class='text-light'>" . $editer_list['department'] . "</td>";
                    echo "</tr>";
                    echo "</tbody>";
                }
                ?>
